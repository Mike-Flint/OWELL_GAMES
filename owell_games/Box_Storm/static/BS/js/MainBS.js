...
if ( window.location.origin + "/BoxStorm/" == window.location.href) {
    history.replaceState(null, '',  window.location.origin + "/BoxStorm/en");
}
else {
...
async function language(lang){
    ...
    const requestUrl = window.location.origin + `/api/v1/BS/languages/${lang}`;
